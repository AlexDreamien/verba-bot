...
MESSAGES: dict[str, dict[str, str]] = {
    "uk": {
        ...
        "btn_lang": "🌐 Мова",
        "btn_help": "❓ Довідка",
        "btn_manual": "📖 Інструкція",
        "btn_admin_manual": "🛠 Інструкція адміна",
        ...
        "sent_to_dm": "👤 Відповідь надіслав у приватний чат.",
        "dm_first": "Спершу відкрий мене в приватному чаті: t.me/{bot}",
        "stats_cooldown": "📊 Рейтинг можна запитувати раз на годину. Спробуй пізніше.",
    ...
    "ru": {
        ...
        "btn_admin_manual": "🛠 Инструкция админа",
        ...
        "sent_to_dm": "👤 Ответ отправил в личный чат.",
        "dm_first": "Сначала открой меня в личном чате: t.me/{bot}",
        "stats_cooldown": "📊 Рейтинг можно запрашивать раз в час. Попробуй позже.",
    ...
    "en": {
        ...
        "sent_to_dm": "👤 Sent to your private chat.",
        "dm_first": "Open me in a private chat first: t.me/{bot}",
        "stats_cooldown": "📊 You can request the leaderboard once per hour. Try later.",
